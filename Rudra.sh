...
echo	" 22. Subjack            23.Gospider                     24.Gxss   "    
echo	"                    200.Install & Setup Tools                   "    
echo    ""
...
case $number in
	...
	10)
		echo -n "Enter the domain: "
		read domain
             	ffuf -w ~/Wordlists/rockyou.txt -u https://$domain/FUZZ
		;;
	11)
		echo -n "Enter the domain: "
		read domain
		python3 ~/Rudra/tools/dirsearch/dirsearch.py -u $domain -e all
		;;
	...
	16)
		echo -n "Enter the domain: "
		read domain
		python3 ~/Rudra/tools/LinkFinder/linkfinder.py -i https://$domain -d 
		;;

	17)
		echo -n "Enter the domain: "
		read domain
		python3 ~/Rudra/tools/SecretFinder/SecretFinder.py -i $domain -o output.html
		;;

	18)
		echo -n "Enter the domain: "
		read domain
		python3 ~/Rudra/tools/ParamSpider/paramspider.py --domain $domain
		;;

	19)
		echo -n "Enter the domain: "
		read domain
		python3 ~/Rudra/tools/Corsy/corsy.py -u https://$domain
		;;
	...
	20)
		echo -n "Enter the domain: "
		read domain
		python3 ~/Rudra/tools/gitGraber/gitGraber.py -k keywordsfile.txt \"$domain\" -s
		;;

	21)
		echo -n "Enter the URL: "
		read  url
		~/Rudra/tools/byp4xx/./byp4xx.sh $url
		;;
